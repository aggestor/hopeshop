"use client"
import { BsFilter, BsListNested, BsPeople, BsPlus } from "react-icons/bs";
            ...
            <div className="w-full mx-auto rounded-xl p-4 bg-white">
                <div className="flex w-full justify-between">
                    ...
                    <GoBack/>
                        ...
                        <span className="w-10 h-10 rounded-xl border grid place-items-center"><BsListNested className="w-6 h-6"/></span> 
